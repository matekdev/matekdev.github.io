...
- Constructed a React app which integrated server-side rendered graph visualizations
...
- Programmed an end-to-end consumer booking system for appointment scheduling
- Setup a UI test suite using Flutter Driver to vigorously test before app deployment
...
- Identified and optimized memory allocations to increase mobile app performance
